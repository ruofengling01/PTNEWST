 ...
 * @author calvin
 */
public class Document3Service {

	private static final String DEFAULT_ENCODING = "utf-8";

	private static Logger logger = LoggerFactory.getLogger(Document3Service.class);
	...
	public void setFreemarkerConfiguration(Configuration freemarkerConfiguration) throws IOException {
		...
		template = freemarkerConfiguration.getTemplate("document3.ftl", DEFAULT_ENCODING);
	}
}
